...
<body>
    <f:view>
        <div class="dashboard-container">
            <div class="dashboard-title">Prescribed Medicines Dashboard</div>
            ...
            <h:form>
                ...
                <h:commandButton value="Submit Medicines" action="#{providerController.prescribedMedicinesSubmit}" 
