...
public class ProviderFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
	    ...
	    boolean isSignUpRequest = uri.endsWith("/provider/SignUp.jsf") || uri.endsWith("/provider/VerifyOtp.jsf") || uri.endsWith("/provider/SearchClaimHistory.jsf")|| uri.endsWith("/provider/GeneratePassword.jsf") || uri.endsWith("/provider/Success.jsf") || uri.endsWith("/provider/LoginWithOtp.jsf") ;
